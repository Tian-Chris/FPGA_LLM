// =============================================================================
// vitis_control.v — Self-contained copy for test_ctrl (no defines.vh dependency)
// =============================================================================
// Identical logic to fpga/rtl/vitis_control.v but with HBM_ADDR_W inlined.
// =============================================================================
...
module vitis_control #(
    ...
    // -------------------------------------------------------------------------
    // Unified Control Register Logic
    // -------------------------------------------------------------------------
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ap_start      <= 1'b0;
