...
def compare_rtl_output(g_prefill, g_decode):
    ...
    with open(RTL_OUT, 'w') as f:
        ...
        rtl_k_cache = extract_matrix_from_hbm(
            flush_words, ACT_BASE + ACT_K_OFFSET, BT_PREFILL, MODEL_STRIDE, MODEL_DIM)
        ...
        rtl_v_cache = extract_matrix_from_hbm(
            flush_words, ACT_BASE + ACT_V_OFFSET, BT_PREFILL, MODEL_STRIDE, MODEL_DIM)
        ...
        rtl_k_new = extract_matrix_from_hbm(
            flush_words, ACT_BASE + ACT_K_OFFSET + PREFILL_LEN * MODEL_STRIDE,
        ...
        rtl_v_new = extract_matrix_from_hbm(
            flush_words, ACT_BASE + ACT_V_OFFSET + PREFILL_LEN * MODEL_STRIDE,
            1, MODEL_STRIDE, MODEL_DIM)
